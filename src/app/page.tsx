...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      slides={[
        ...
        },
        {
          ...
          imageAlt: "Dynamic server room",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/people-analyzing-checking-finance-graphs-office_23-2150377179.jpg",
          imageAlt: "Team of software developers collaborating",
        },
        {
          ...
          imageAlt: "Tablet displaying a mobile application",
        },
        {
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/futuristic-dubai-landscape_23-2151339747.jpg",
          imageAlt: "Overhead view of a smart city",
        },
      ]}
      autoplayDelay={4000}
      showDimOverlay={true}
      ...
      features={[
        {
          ...
          imageAlt: "Code transforming into user interface",
        },
        {
          id: "f2",
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/cloud-system-tablet-background-smart-technology-remixed-media_53876-124705.jpg",
        ...
        },
        {
          ...
          imageAlt: "Abstract data analytics visualization",
        },
        {
          id: "f4",
          ...
          imageAlt: "Sleek mobile app interface",
        },
        {
          id: "f5",
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/server-room-coworkers-using-artificial-intelligence-laptop-tablet_482257-122618.jpg",
        ...
        },
        {
          ...
          imageAlt: "Software dashboard with UI elements",
        },
      ]}
  ...
  <div id="products" data-section="products">
      ...
      products={[
        {
          id: "p1",
          brand: "Blueline Solutions",
          name: "Enterprise Suite Pro",
          price: "$299/month",
          rating: 5,
          reviewCount: "120",
          imageSrc: "http://img.b2bpic.net/free-photo/business-man-seated-home-office-space-looking-report_1423-244.jpg",
          imageAlt: "ERP System Dashboard",
        },
        {
          id: "p2",
          brand: "Blueline Solutions",
          name: "Connect CRM Advanced",
          price: "$99/month",
          rating: 4.8,
          reviewCount: "85",
          imageSrc: "http://img.b2bpic.net/free-photo/customer-relationship-management-concept_23-2150038403.jpg",
          imageAlt: "CRM Mobile App",
        },
        {
          id: "p3",
          brand: "Blueline Solutions",
          ...
          imageAlt: "Project Management Software",
        },
        {
          id: "p4",
          brand: "Blueline Solutions",
          name: "RetailNet E-commerce",
          price: "$149/month",
          rating: 4.7,
          reviewCount: "70",
          imageSrc: "http://img.b2bpic.net/free-photo/online-payment-purchase-e-commerce-buy-icon_53876-133903.jpg",
          imageAlt: "E-commerce Platform Backend",
        },
        {
          id: "p5",
          brand: "Blueline Solutions",
          ...
          imageAlt: "AI-powered Data Analytics Platform",
        },
        {
          id: "p6",
          brand: "Blueline Solutions",
          name: "Guardian Secure",
          price: "$79/month",
          rating: 4.9,
          reviewCount: "110",
      ...
      testimonials={[
        {
          ...
          name: "Thuy Nguyen Ba",
          handle: "@ThuyNB_CEO",
          testimonial: "Blueline Solutions Vinh not only delivers exceptional software but also fosters a dynamic and inspiring work environment. Their commitment to quality and innovation is truly commendable, and we've seen significant improvements.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/young-handsome-man-office-center_1303-19604.jpg",
          imageAlt: "Thuy Nguyen Ba, CEO",
        },
        {
          id: "t2",
          name: "Minhchi Phanba",
          handle: "@MinhchiP_CTO",
          testimonial: "Blueline Solutions consistently delivers high-quality products with a team that is professional, friendly, and collaborative. They truly understand client needs and exceed expectations in every project.",
          rating: 5,
          ...
          imageAlt: "Minhchi Phanba, CTO",
        },
        {
          id: "t3",
          name: "Đức Dương",
          handle: "@DucD_PM",
          testimonial: "Choosing Blueline Solutions Vinh was one of our best decisions. Their team is dedicated, and the solutions provided are meticulously crafted and highly effective, driving real business value.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/man-black-suit-using-tablet-smiles_23-2148401471.jpg",
          imageAlt: "Đức Dương, Project Manager",
        },
        {
          id: "t4",
          name: "Sarah Johnson",
          handle: "@SarahJ_Mkt",
          testimonial: "The custom software developed by Blueline Solutions has significantly streamlined our marketing operations, giving us a powerful edge in a competitive market. Their expertise is unmatched.",
          rating: 5,
        ...
        },
        {
          id: "t5",
          name: "Michael Chen",
          handle: "@MichaelC_Founder",
          testimonial: "As a startup founder, I needed a reliable tech partner, and Blueline Solutions delivered beyond my expectations. Their agile approach and innovative solutions are truly exceptional.",
          rating: 5,
        ...
        },
        {
          ...
          handle: "@EmilyR_IT",
          testimonial: "Their IT consulting services were invaluable in optimizing our infrastructure. Blueline Solutions provided strategic insights and robust solutions that greatly improved our system performance.",
          rating: 5,
          ...
          imageAlt: "Emily Rodriguez, IT Director",
        },
      ]}
      showRating={true}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "What types of software solutions do you develop?",
          content: "We specialize in custom software development, including web and mobile applications, enterprise resource planning (ERP) systems, customer relationship management (CRM) software, and AI-powered platforms tailored to your specific business needs.",
        },
        {
          id: "q2",
          title: "What is your software development process?",
          content: "Our process typically involves discovery and planning, UI/UX design, agile development sprints, rigorous testing, deployment, and ongoing support. We prioritize transparency and collaboration at every stage.",
        },
        {
          id: "q3",
          title: "How do you ensure data security and privacy?",
          content: "Data security and privacy are paramount. We implement industry-leading encryption protocols, secure coding practices, regular security audits, and adhere to relevant compliance standards to protect your sensitive information.",
        },
        {
          id: "q4",
          title: "Do you offer post-launch support and maintenance?",
          content: "Yes, we provide comprehensive post-launch support and maintenance packages. This includes bug fixes, performance monitoring, updates, and ongoing enhancements to ensure your software remains robust and up-to-date.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Get in Touch",
          href: "mailto:solutions@blueline.com.vn",
        },
        {
          text: "Call Us",
          href: "tel:+84904723257",
        },
      ]}
    />
  </div>
